...
var postAPI = 'https://my-json-server.typicode.com/nghiattps13085/apigoldenowl/shoes?fbclid=IwAR1RfD4e-rAxKgeZ-k9zdIQwxo9Ph-fdwBY6VW3hLngAKoO2cXHJeVb1RZE';
...
fetch(postAPI)
			...
			.then(function(posts){
				var htmls = posts.map(function(post){
					return `<li>
                            <img style="background-color:${post.color} " src="${post.image}">
							<h2>${post.name}</h2>
                ...
                function onLoadCartNumbers() {
                    ...
                    if(productNumbers){
                        document.querySelector('.cart-item span').textContent = productNumbers;
                    }
                }
                function cartNumbers(products){
                    ...
                    if(productNumbers){
                        ...
                        document.querySelector('.cart-item span').textContent = productNumbers + 1;
                    }else {
